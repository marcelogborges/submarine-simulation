...
namespace glm
{
	...
	{
		return vec<3, T, Q>(rotate_y(x), rotate_z(x), rotate_x(x));
	}

	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER T rotate_x(qua<T, Q> const& q)
	{
		return static_cast<T>(atan(static_cast<T>(2) * (q.x * q.y + q.w * q.z), q.w * q.w + q.x * q.x - q.y * q.y - q.z * q.z));
	}

	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER T rotate_y(qua<T, Q> const& q)
	{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER T rotate_z(qua<T, Q> const& q)
	{
