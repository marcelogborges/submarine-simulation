...
#	endif
	...
	//(
	//	valType const& rotate_y,
	//	valType const& rotate_z,
	//	valType const& rotate_x
	//)
	//{
	//	vec<3, valType> eulerAngle(rotate_y * valType(0.5), rotate_z * valType(0.5), rotate_z * valType(0.5));
